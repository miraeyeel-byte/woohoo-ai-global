...
with tabs[1]:
    ...
    st.info("AI 연산 노드 최적화 상태: 95%")
    st.progress(95)

# --- 탭 3: 닷지 게임 (버그 수정 및 참가비 반영) ---
with tabs[2]:
